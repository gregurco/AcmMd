...
class CHttpRequest extends CApplicationComponent
{
	 ...
	 * an error message like this: "Internet Explorer was not able to open this Internet profile. The requested profile is either unavailable or cannot be found.".
