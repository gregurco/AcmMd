            ...
            <div style="text-align: -webkit-center;">
                <?php $this->widget('zii.widgets.CMenu',array(
                    'items'=>array(
                        ...
                        array('label'=>'Войти', 'url'=>array('/profile/login'), 'visible'=>Yii::app()->user->isGuest),
                        array('label'=>'Регистрация', 'url'=>array('/profile/register'), 'visible'=>Yii::app()->user->isGuest),
                        array('label'=>'Выйти ('.Yii::app()->user->name.')', 'url'=>array('/profile/logout'), 'visible'=>!Yii::app()->user->isGuest),
                    ),
